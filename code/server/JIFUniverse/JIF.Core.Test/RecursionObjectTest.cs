...
namespace JIF.Core.Test
{
    ...
    public class RecursionObjectTest
    {
        ...
        public void GetCategoriesTree_Test()
        {
            ...
            {
                new ArticleCategory { Id = 1, Name = "图书", ParentId = 0, Order= 2 },
                new ArticleCategory { Id = 2, Name = "电子", ParentId = 0, Order= 1 },
                new ArticleCategory { Id = 3, Name = "建材", ParentId = 0, Order = 3 },
                new ArticleCategory { Id = 4, Name = "服装", ParentId = 0, Order = 4 },
